...
#ifndef __SCIP_SEPA_Chvatal_Gomory_Multiple_Sep
#define __SCIP_SEPA_Chvatal_Gomory_Multiple_Sep
...
class ChvatalGomoryMultipleSep : public scip::ObjSepa{
	public:
	/************************************************************/
	...
	ChvatalGomoryMultipleSep(SCIP* scip,C_master_coloring* _master, int nb_nodes_	 )
	...
	//Destructeur
	virtual ~ChvatalGomoryMultipleSep(){
	};
