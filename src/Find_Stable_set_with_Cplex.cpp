...
void Cplex_pricing_algo::set_objective_coefficient(const vector<SCIP_Real>& obj_coeff, const vector<SCIP_Real>& coeff_additional){
 int i;
...
void Cplex_pricing_algo::modify_pricer(list<Constraint*> ct){
...
bool  Cplex_pricing_algo::find_stableset(StableSet* stable, SCIP_Real& objvalue, vector<int>* coefficients) {
